      ...
      <div className="tc">
        <header className="sticky" style={{ borderBottom: "3px solid black" }}>
          ...
          <p className="pa2 ma2 fw3 description-text">
            Learn From Home is an initiative by Tuples Edu. Search Education, Entertainment, Health, Productivity, Others to find relevant cards/links.
          </p>
          ...
          <h5>{filteredresources.length} resource(s) found</h5>
        </header>
